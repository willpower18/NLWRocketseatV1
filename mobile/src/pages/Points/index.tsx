...
const Points = () =>{
  ...
  function handleNavigateToDetail(id: number){
    navivation.navigate('Details', { point_id: id });
  }
  ...
  //Estado da Aplicação
    ...
    //Abre o Mapa na localização do usuário
    useEffect(() =>{
        ...
        <>
            <View style={styles.container}>
                ...
                <View style={styles.mapContainer}>
                    {initialPosition[0] !== 0 && (//if que verifica o valor da initialPosition, se for diferente de 0 renderiza o mapa
                      <MapView 
                      style={styles.map}
                      initialRegion={
